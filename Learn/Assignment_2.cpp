...
GameObject Floor("Floor",CVector(0, -1 - 0.05, 0));
GameObject A("A", CVector(0, 6, 0));
GameObject B1("B1", CVector(-(9 + 8 * 0.05) / 2 + 0.5, 0, 0));
GameObject B2("B2", CVector(-(15 + 14 * 0.05) / 2 + 0.5, 1, -4 - 4 * 0.05));
GameObject C("C", CVector(0, 2.5 + 5.5, 5));
GameObject E29("E29", CVector(-(29 + 28 * 0.05) / 2 + 0.5, 20, 0));
GameObject E25("E25", CVector(-(25 + 24 * 0.05) / 2 + 0.5, 20, 0));
GameObject Car("Car", CVector(0, 0.5+2.5, 0));
