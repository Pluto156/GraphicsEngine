#include "stdafx.h"
#include "CMatrix3.h"
const CMatrix3 CMatrix3::Zero = CMatrix3(0.0f);
const CMatrix3 CMatrix3::Identity = CMatrix3(1.0f);

CMatrix3 CMatrix3::CreateRotation(const CVector3& axis, float angle)
{
	return CMatrix3(axis, angle);
}
...
CMatrix3::CMatrix3(const CMatrix3& mat3)
{
...
CMatrix3::CMatrix3(const CMatrix4& mat4)
{
...
CMatrix3::CMatrix3(const CVector3& v1, const CVector3& v2, const CVector3& v3)
{
...
CMatrix3::CMatrix3(const CVector3& v)
{
...
CMatrix3::CMatrix3(const CVector3& axis, float angle)
{
...
float CMatrix3::Get(uint32_t row, uint32_t col) const
{
	return m[row][col];
}

CVector3 CMatrix3::GetRow(uint32_t index) const
{
	switch (index)
	{
	case 0:
		return CVector3(m00, m01, m02);
	case 1:
		return CVector3(m10, m11, m12);
	case 2:
		return CVector3(m20, m21, m22);
	default:
...
CVector3 CMatrix3::GetColumn(uint32_t index) const
{
	switch (index)
	{
	case 0:
...
CMatrix3 CMatrix3::GetTranspose()
{
	CMatrix3 t(*this);
	t.Transpose();
	return t;
...
void CMatrix3::ToRowMajorArray(float* array) const
{
...
void CMatrix3::ToColumnMajorArray(float* array) const
{
...
std::string CMatrix3::ToString() const
{
	return "\n"
...
CMatrix3& CMatrix3::operator= (const CMatrix3& mat)
{
...
bool CMatrix3::operator== (const CMatrix3& mat) const
{
...
CMatrix3 CMatrix3::operator* (float n) const
{
	return CMatrix3(
		m00 * n, m01 * n, m02 * n,
		m10 * n, m11 * n, m12 * n,
...
CMatrix3 CMatrix3::operator+ (const CMatrix3& mat) const
{
	return CMatrix3(
		m00 + mat.m00, m01 + mat.m01, m02 + mat.m02,
		m10 + mat.m10, m11 + mat.m11, m12 + mat.m12,
...
CMatrix3& CMatrix3::operator*= (float n)
{
	m00 *= n; m01 *= n; m02 *= n;
	m10 *= n; m11 *= n; m12 *= n;
	m20 *= n; m21 *= n; m22 *= n;
...
CVector3 CMatrix3::operator* (const CVector3& v) const
{
...
CMatrix3 operator* (float n, const CMatrix3& mat)
{
	return CMatrix3(
